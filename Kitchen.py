...
#__________________________________________________________________Order cancellation
    ...
    cancel_win_label = Label(cancel_win_frame, text="===== Order is Cancelled =====", font=('Arial', 20, 'bold'), bd=15, relief='groove',pady=5)
...
cancel = Button(cancel_button_frame,text="Cancel Order",font=('Arial',20,'bold'),width=20,height=1, command= cancel)
cancel.pack()
